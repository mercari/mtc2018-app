  ...
  Widget buildSpeakerInformation() {
    return Column(
      ...
      children: <Widget>[
        ...
        Container(margin: const EdgeInsets.only(bottom: 20.0), child: Text(speaker.description)),
        buildLinkLabels()
      ]
    );
  }
  ...
  Widget buildSessionSpeakerInformation() {
    return Container(
      child: ListTile(
        ...
        title: Text(speaker.name, style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
        subtitle: Text(speaker.type, style: TextStyle(color: Colors.white)),
